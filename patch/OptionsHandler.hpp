...
template <class TargetType> multipleValueOption<TargetType>::multipleValueOption(const std::string& name, TargetType& valueToSet,
		...
		const std::string& helpString): NamedOption(name,helpString), d_valueToSet(valueToSet) {
	d_nameMap.insert(std::make_pair<std::string,TargetType>(std::string(name1),TargetType(value1)));
}
template <class TargetType> multipleValueOption<TargetType>::multipleValueOption(const std::string& name, TargetType& valueToSet,
		const std::string& name1, const TargetType& value1,
		...
		const std::string& helpString): NamedOption(name,helpString), d_valueToSet(valueToSet) {
	d_nameMap.insert(std::make_pair<std::string,TargetType>(std::string(name1),TargetType(value1)));
	d_nameMap.insert(std::make_pair<std::string,TargetType>(std::string(name2),TargetType(value2)));
}
template <class TargetType> multipleValueOption<TargetType>::multipleValueOption(const std::string& name, TargetType& valueToSet,
		const std::string& name1, const TargetType& value1,
		const std::string& name2, const TargetType& value2,
	...
	d_nameMap.insert(std::make_pair<std::string,TargetType>(std::string(name1),TargetType(value1)));
	d_nameMap.insert(std::make_pair<std::string,TargetType>(std::string(name2),TargetType(value2)));
	d_nameMap.insert(std::make_pair<std::string,TargetType>(std::string(name3),TargetType(value3)));
}
template <class TargetType> multipleValueOption<TargetType>::multipleValueOption(const std::string& name, TargetType& valueToSet,
		const std::string& name1, const TargetType& value1,
		const std::string& name2, const TargetType& value2,
	...
	d_nameMap.insert(std::make_pair<std::string,TargetType>(std::string(name2),TargetType(value2)));
	d_nameMap.insert(std::make_pair<std::string,TargetType>(std::string(name3),TargetType(value3)));
	d_nameMap.insert(std::make_pair<std::string,TargetType>(std::string(name4),TargetType(value4)));
}
template <class TargetType> multipleValueOption<TargetType>::multipleValueOption(const std::string& name, TargetType& valueToSet,
		const std::string& name1, const TargetType& value1,
		const std::string& name2, const TargetType& value2,
	...
	d_nameMap.insert(std::make_pair<std::string,TargetType>(std::string(name3),TargetType(value3)));
	d_nameMap.insert(std::make_pair<std::string,TargetType>(std::string(name4),TargetType(value4)));
	d_nameMap.insert(std::make_pair<std::string,TargetType>(std::string(name5),TargetType(value5)));
}
